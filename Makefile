...
figures/fig_03_timing_diffs.pdf: ramp_fits/traces/NGRIP.gz ramp_fits/traces/NEEM.gz
	python fig_03_timing_diffs.py

figures/fig_02_example_fit.pdf: ramp_fits/traces/NGRIP.gz ramp_fits/traces/NEEM.gz
	python fig_02_example_fit.py

figures/fig_04_combined_evidence.pdf: ramp_fits/traces/NGRIP.gz ramp_fits/traces/NEEM.gz
